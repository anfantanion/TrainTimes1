...
class SearchRecyclerAdapterFloat() : RecyclerView.Adapter<SearchRecyclerAdapterFloat.ViewHolder>(), Filterable  {
    val TAG = "SearchRecyclerAdarFloat"
    ...
    fun swapData(stations: List<Station>){

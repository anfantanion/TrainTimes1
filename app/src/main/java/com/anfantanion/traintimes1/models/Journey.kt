...
class Journey(
    ...
    fun plan(journeyListener: JourneyPlanner.JourneyListener){
        ...
        journeyPlanner.plan(waypoints.toList())
    }
    ...
    class JourneyPlanner : Response.ErrorListener
    {
        ...
        fun nextStation(){
            ...
            RTTAPI.requestStation(waypoints[index],StationResponseListener(),this,filter )
        }
        ...
        fun stationResponse(response: StationResponse?){
            ...
            RTTAPI.requestService(interestedService.toServiceStub(),ServiceResponseListener(),this)
        }
        ...
        inner class StationResponseListener : Response.Listener<StationResponse>{
            override fun onResponse(response: StationResponse?) {
                stationResponse((response))
            }
        }
        inner class ServiceResponseListener : Response.Listener<ServiceResponse>{
